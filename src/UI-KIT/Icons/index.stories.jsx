...
const meta = {
  ...
  argTypes: {
    ...
    size: {
      description:
        "Необязательный параметр размера иконки. По умолчанию стандартный размер 32px, кроме иконки OctopusArrow у которой стандартный размер 60px. Может принимать значения - 24 | 32 | 60",
